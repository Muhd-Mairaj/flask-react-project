...
function Header() {
  ...
  return (
    <Navbar collapseOnSelect fixed="top" expand="sm" bg="dark" variant="primary" className="Header">
      <Container fluid>
          ...
          {isLoggedIn === true ?
            <>
              ...
              <Nav>
                  ...
                  <NavDropdown title="Dropdown" variant="dark" id="collasible-nav-dropdown">
