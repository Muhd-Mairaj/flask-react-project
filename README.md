...
- Developing a good code structure to promote adding features and to reduce future development time,
  - This includes seperating the code into directories such as "Components" for repeating components and "Contexts" for [React Contexts](https://reactjs.org/docs/context.html)
