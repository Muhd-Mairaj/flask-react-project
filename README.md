...
Additionally, I used React for the front end to implement client-side routing features. As such navigation throughout the application is still possible bar some 
