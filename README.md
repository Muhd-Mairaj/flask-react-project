...
If you tried to test the application, it would appear pretty basic. In its current stage, priority was given to the Authentication and Security features, ensuring a good 
