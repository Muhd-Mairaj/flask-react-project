...
- Developing a good code structure to promote adding features and to reduce future development time,
  ...
  - etc...
- ~~(And also... my own researching of different concepts involving the web tools to pick the right choce for my project, along with learning the new languages involved.)~~
