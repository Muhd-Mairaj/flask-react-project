...
If you tried to test the application, it would appear pretty basic. In its current stage, priority was given to the Authentication and Security features, developing a good foundation structure that promotes expanding the app and development
